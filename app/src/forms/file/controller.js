      ...
      const applicationJSON = {
        'Community and Employer Partnerships Application': {
          ...
          'Project Information': {
            ...
            ...(submission.CEPTargetAboriginalCount && { 'Target Group: Indigenous Peoples': submission.CEPTargetAboriginalCount }),
            ...(submission.CEPTargetFrancophoneCount && { 'Target Group: Francophone': submission.CEPTargetFrancophoneCount }),
            ...(submission.CEPTargetImmigrantCount && { 'Target Group: Immigrants': submission.CEPTargetImmigrantCount }),
            ...(submission.CEPTargetBarrieredCount && { 'Target Group: Multi-barriered': submission.CEPTargetBarrieredCount }),
            ...(submission.CEPTargetDisabilitiesCount && { 'Target Group: Persons with a Disability': submission.CEPTargetDisabilitiesCount }),
            ...(submission.CEPTargetYouthCount && { 'Target Group: Youth': submission.CEPTargetYouthCount }),
            ...(submission.CEPTargetSurvivorsOfViolenceCount && { 'Target Group: Survivors of Violence and/or Abuse': submission.CEPTargetSurvivorsOfViolenceCount }),
            ...(submission.CEPTargetWomenCount && { 'Target Group: Women': submission.CEPTargetWomenCount }),
            ...(submission.CEPTargetRacializedCount && { 'Target Group: Racialized People': submission.CEPTargetRacializedCount }),
            ...(submission.CEPTargetLGBTCount && { 'Target Group: 2SLGBTQIA+': submission.CEPTargetLGBTCount }),
            ...(submission.CEPTargetMatureWorkersCount && { 'Target Group: Mature Workers': submission.CEPTargetMatureWorkersCount }),
            ...(submission.CEPTargetOtherCount && { 'Target Group: Other': submission.CEPTargetOtherCount }),
          ...
          'Project Activities': {
            ...
            ...(submission.CEPPBLMTClassPercent && { 'Classroom Percentage': submission.CEPPBLMTClassPercent }),
            ...(submission.CEPPBLMTWorkPercent && { 'Work Percentage': submission.CEPPBLMTWorkPercent }),
            ...(submission.CEPObj_PBLMT_Sessions && { 'Intake Dates': submission.CEPObj_PBLMT_Sessions }),
            ...(submission.CEPObj_PBLMT_SessionCount && { 'Number of Sessions': submission.CEPObj_PBLMT_SessionCount }),
            ...(submission.CEPObj_PBLMT_PartPerSessionCount && { 'Participants Per Intake': submission.CEPObj_PBLMT_PartPerSessionCount }),
            ...(submission.CEPObj_PBLMT_TrainingWeeks && { 'Weeks of Skills': submission.CEPObj_PBLMT_TrainingWeeks }),
            ...(submission.CEPObj_PBLMT_JobWeeks && { 'Weeks of Work': submission.CEPObj_PBLMT_JobWeeks }),
            ...(submission.CEPObj_PBLMT_FollowupWeeks && { 'Weeks of Support': submission.CEPObj_PBLMT_FollowupWeeks }),
