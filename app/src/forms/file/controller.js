      ...
      const applicationJSON = {
        'Community and Employer Partnerships Application': {
          ...
          'Primary Contact / Accounting': {
            ...
            ...(submission.CEPOtherGovtFundingExplanation && { 'Other Government Funding Explanation': submission.CEPOtherGovtFundingExplanation }),
            ...(submission.CEPWORKBCDelivery && { 'WorkBC Delivery': submission.CEPWORKBCDelivery }),
            ...(submission.CEPWORKBCDeliveryOther && { 'WorkBC Delivery Explanation': submission.CEPWORKBCDeliveryOther }),
            ...(submission.CEPWORKBCConflict && { 'Conflict of Interest': submission.CEPWORKBCConflict }),
            ...
            ...(submission.CEPDisputeExplanation && { 'Stoppage or Dispute Explanation': submission.CEPDisputeExplanation }),
          ...
          'Project Information': {
            ...
            ...(submission.CEPObj_JCP_PartBenefit && { 'Participant Benefits': submission.CEPObj_JCP_PartBenefit }),
          },
          'Project Activities': {
            ...(submission.CEPObj_RI_EthicsPolicy && { 'Ethics Policy': submission.CEPObj_RI_EthicsPolicy }),
            ...(submission.CEPObj_RI_Market && { Market: submission.CEPObj_RI_Market }),
            ...(submission.CEPObj_RI_TargetPop && { 'Target Population': submission.CEPObj_RI_TargetPop }),
            ...(submission.CEPObj_RI_Subjects && { 'Research Subjects': submission.CEPObj_RI_Subjects }),
            ...(submission.CEPObj_RI_Reporting && { Reporting: submission.CEPObj_RI_Reporting }),
            ...(submission.CEPObj_RI_Sustainment && { Sustainment: submission.CEPObj_RI_Sustainment }),
            ...(submission.CEPPTimelinesActivities_JCP && { 'Key Activities': submission.CEPPTimelinesActivities_JCP }),
            ...(submission.CEPPTimelinesActivities_LMP && { 'Key Activities': submission.CEPPTimelinesActivities_LMP }),
            ...
            ...(submission.CEPSupervisionExplanation && { 'Supervision Explanation': submission.CEPSupervisionExplanation }),
            ...(submission.CEPProgressExplanation && { 'Progress Explanation': submission.CEPProgressExplanation }),
            ...(submission.CEPFollowUpExplanation && { 'Follow-up Explanation': submission.CEPFollowUpExplanation }),
            ...(submission.CEPIPRights && { 'Intellectual Property Rights': submission.CEPIPRights }),
            ...(submission.CEPIPRightsExplanation && { 'Intellectual Property Explanation': submission.CEPIPRightsExplanation }),
            ...
            ...(submission.CEPPBLMT_LabourMarket && { 'Labour Market Imbalance': submission.CEPPBLMT_LabourMarket }),
          },
          Budget: {
